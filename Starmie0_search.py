...
class Stamie0_Search:
    """
    Stamie0_Search is a class for performing  re_ranking of unionable tables using Stamie scoring with manula alignemnt and geting sum 
    ...
    def perform_search_optimized(self, p_degree, k, all_vectors):
        ...
        for query_name in q_table_names:
                    ...
                    for dl_table_name in dl_table_names:
                                    ...
                                    # Calculate  unionability scores for each row
                                    merged_data['starmie0_unionability_score'] = (
...
if __name__ == "__main__":
    ...
    search_results_file=dataFolder+"/diveristy_data/search_results/starmie0/search_result_starmie0_04diluted_restricted_pdeg1.csv"
    ...
    dsize=20
    penalize_search = Stamie0_Search(dsize, dataFolder, table_path, query_path_raw, table_path_raw, processed_path, index_file_path)
